            ...
            <div class="row justify-content-md-center h-100">
                <div class="col-sm-4 " style="margin-top: auto; margin-bottom: auto;">
                    <div class="card" style="background-color: #f7f7f7;">
                        ...
                        <div class="card-body">
                            <h4 class="card-title" style="color: darkslategray">Login</h4>
                            <form action="login.php" method="POST">
                                ...
                                if($invalid_credentials){
                                    echo "<div class=\"alert alert-danger\"><strong>Error!</strong> Bad credentials!</div>";
                                }
                                ?>
                            ...
                            <p style="color: darkslategray">Don't have an account? <a href="registration.php" class="card-link">Signup</a></p>
                        </div>
                    </div>
                </div>
            </div>
