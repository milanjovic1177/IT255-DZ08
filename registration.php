    ...
    if (isset($email) && isset($password) && isset($password2)) {
        if(strcmp($password, $password2) == 0) {
            if(createAccount($email, $password)) {
                $_SESSION['isLoggedInToMetHostel'] = true;
                header("Location: index.php");
                die();
            } else {
                $error_signing_up = true;
            }
        } else {
            $pwds_not_equal = true;
        }
...
<body>
    ...
    <div class="container-fluid" style="padding-left: 0px; padding-right: 0px; background-color: #f7f7f7;">
        ...
        <div class="container-fluid " style="background: url('images/hotel_0.jpg'); background-size: cover; width:100%; height: 60vh; max-height: 850px;">
            ...
            <div class="row justify-content-md-center h-100">
                <div class="col-sm-4 " style="margin-top: auto; margin-bottom: auto;">
                    <div class="card" style="background-color: #f7f7f7;">
                        ...
                        <div class="card-body">
                            <h4 class="card-title" style="color: darkslategray">Signup</h4>
                            <form action="registration.php" method="POST">
                                <div class="form-group">
                                    <label for="email">Email address:</label>
                                    <?php echo "<input type=\"email\" value=\"$email\" class=\"form-control\" id=\"email\" name=\"email\">"; ?>
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Password:</label>
                                    <?php echo "<input type=\"password\" value=\"$password\" class=\"form-control\" id=\"pwd\" name=\"pwd\">"; ?>
                                </div>
                                <div class="form-group">
                                    <label for="pwd_repeat">Repeat Password:</label>
                                    <?php echo "<input type=\"password\" value=\"$password2\" class=\"form-control\" id=\"pwd_repeat\" name=\"pwd_repeat\">"; ?>
                                </div>
                                
                                <?php
                                if($pwds_not_equal){
                                    echo "<div class=\"alert alert-danger\"><strong>Error!</strong> Psswords not equal!</div>";
                                } else if($error_signing_up){
                                    echo "<div class=\"alert alert-danger\"><strong>Error!</strong> Account with this email already exist!</div>";
                                }
                                ?>
                            ...
                            <p style="color: darkslategray">Already have an account? <a href="login.php" class="card-link">Login</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container room-cards-container" style="margin-top: 2rem">
            <div class="row">
                <div class="col-sm-4">
